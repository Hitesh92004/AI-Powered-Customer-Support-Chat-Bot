            ...
            <div className="sticky top-0 z-10 glass-panel border-b border-white/10 px-6 py-4 flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-xs">How this full-stack AI platform works</p>
                </div>
              </div>
              <button
            ...
            <div className="p-6 space-y-8">
              ...
              <div className="bg-slate-900/50 rounded-xl p-6 border border-white/5 relative overflow-hidden group">
                ...
                <h3 className="text-sm font-semibold text-gray-200 mb-6 flex items-center gap-2">
                  <BrainCircuit className="text-primary" size={16} /> Data Flow Diagram
                </h3>
                ...
                <div className="flex flex-col md:flex-row items-center justify-between gap-4">
                  ...
                  <div className="flex-1 w-full glass-panel p-4 rounded-xl text-center relative z-10 hover:-translate-y-1 transition-transform duration-300">
                    ...
                    <h4 className="text-sm font-bold text-white mb-1">1. React Frontend</h4>
                    <p className="text-[10px] text-gray-400">User sends message via Vite UI. Server-Sent Events (SSE) stream back response chunks.</p>
                  </div>
                  ...
                  <div className="flex-1 w-full glass-panel border-primary/30 p-4 rounded-xl text-center relative z-10 hover:-translate-y-1 transition-transform duration-300 shadow-lg shadow-primary/10">
                    ...
                    <h4 className="text-sm font-bold text-white mb-1">2. FastAPI Backend</h4>
                    <p className="text-[10px] text-gray-400">Routes request, extracts intent via Scikit-Learn, and checks Postgres for FAQ context.</p>
                  </div>
                  ...
                  <div className="flex-1 w-full glass-panel p-4 rounded-xl text-center relative z-10 hover:-translate-y-1 transition-transform duration-300">
                    ...
                    <h4 className="text-sm font-bold text-white mb-1">3. Groq (Llama 3)</h4>
                    <p className="text-[10px] text-gray-400">Injects FAQ context and generates the final streaming response via lightning-fast Groq API.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="glass-panel p-5 rounded-xl relative overflow-hidden">
                  ...
                  <h4 className="text-sm font-bold text-white mb-3 border-b border-white/10 pb-2">Backend Stack</h4>
                  <ul className="space-y-2 text-xs text-gray-300">
                    <li className="flex items-start gap-2">
                      <span className="w-1.5 h-1.5 rounded-full bg-secondary mt-1.5"></span>
                      <span><strong>Python FastAPI:</strong> Asynchronous high-performance routing.</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="w-1.5 h-1.5 rounded-full bg-secondary mt-1.5"></span>
                      <span><strong>Neon DB (PostgreSQL):</strong> Serverless vector search mapping exact FAQ criteria.</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="w-1.5 h-1.5 rounded-full bg-secondary mt-1.5"></span>
                      <span><strong>Scikit-Learn Router:</strong> Custom intent classifier routing to human fallback.</span>
                    </li>
                  </ul>
                </div>
              </div>
